                        ...
                        <div class="tab-pane fade show active step-content">
                            ...
                            <div class="mb-3">
                                ...
                                <input type="text" class="form-control" id="phone" name="phone" maxlength="10"
                                    minlength="10" value="{{ old('phone', $user->phone) }}">
                                @error('phone')
                                    <span class="text-danger">{{ $message }}</span>
                                @enderror
                            </div>
                            ...
                            <div id="skills-container">
                                @foreach ($user->skills as $skill)
                                    <div class="skill-row mb-3 d-flex align-items-center">
                                        <input type="text" class="form-control me-2 skill-input flex-grow-1"
                                            name="skills[]" placeholder="Enter skill" style="max-width: 600px;"
                                            value="{{ $skill->name }}">
...
@section('scripts')
    <script>
        ...
        function showStep(step) {
            ...
            nextBtn.innerText = step === steps.length - 1 ? 'UPDATE' : 'NEXT';
        }
